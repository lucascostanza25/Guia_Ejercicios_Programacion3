...
class Auto
{
    ...
    {
        $archivo = fopen("autos.csv", "a") or die("No se puedo abrir el archivo");
        $datos = array($auto->_color, $auto->_precio, $auto->_marca, $auto->_fecha);
    ...
    {
        $autos = array();
        if($archivo = fopen("autos.csv", "r") === true)
        {
